...
<div class="px-4 py-6 sm:px-0">
    <div class="border-4 border-dashed border-gray-200 rounded-lg p-6">
        ...
        <div class="mb-6">
            ...
            <p class="mt-1 text-sm text-gray-600">Tracking: <?php echo e($shipment->tracking_number); ?></p>
        </div>
            ...
            <div class="px-4 py-5 sm:p-6">
                ...
                <dl class="space-y-3">
                    <div class="flex justify-between">
                        ...
                        <dd class="text-sm text-gray-900"><?php echo e($shipment->tracking_number); ?></dd>
                    </div>
                    <div class="flex justify-between">
                        <dt class="text-sm font-medium text-gray-500">Invoice</dt>
                        <dd class="text-sm text-gray-900">
                            <a href="<?php echo e(route('admin.invoices.show', $shipment->invoice)); ?>" class="text-indigo-600 hover:text-indigo-900">
                    ...
                    <div class="flex justify-between">
                        ...
                        <dd class="text-sm text-gray-900"><?php echo e($shipment->invoice->order->customer_name); ?></dd>
                    </div>
                    <div class="flex justify-between">
                        <dt class="text-sm font-medium text-gray-500">Courier</dt>
                        <dd class="text-sm text-gray-900"><?php echo e($shipment->courier_name); ?></dd>
                    </div>
                    <div class="flex justify-between">
                    ...
                    <div class="flex justify-between">
                        ...
                        <dd class="text-sm text-gray-900"><?php echo e($shipment->created_at->format('M d, Y')); ?></dd>
                    </div>
                    <?php if($shipment->shipped_date): ?>
                        <div class="flex justify-between">
                            <dt class="text-sm font-medium text-gray-500">Shipped Date</dt>
                            <dd class="text-sm text-gray-900"><?php echo e($shipment->shipped_date->format('M d, Y')); ?></dd>
                        </div>
                    <?php endif; ?>
                    <?php if($shipment->delivered_date): ?>
                        <div class="flex justify-between">
                            <dt class="text-sm font-medium text-gray-500">Delivered Date</dt>
                            <dd class="text-sm text-gray-900"><?php echo e($shipment->delivered_date->format('M d, Y')); ?></dd>
                        </div>
                    <?php endif; ?>
                </dl>
                ...
                <div class="mt-6">
                    ...
                    <p class="text-sm text-gray-600"><?php echo e($shipment->shipping_address); ?></p>
                </div>

                <?php if($shipment->notes): ?>
                    <div class="mt-6">
                        <h4 class="text-sm font-medium text-gray-900 mb-2">Notes</h4>
                        <p class="text-sm text-gray-600"><?php echo e($shipment->notes); ?></p>
                    </div>
                <?php endif; ?>
            </div>
        </div>
        ...
        <?php if($shipment->status !== 'delivered'): ?>
            <div class="bg-white shadow sm:rounded-lg mt-6">
                <div class="px-4 py-5 sm:p-6">
                    ...
                    <form method="POST" action="<?php echo e(route('admin.shipments.updateStatus', $shipment)); ?>" class="space-y-4">
                        <?php echo csrf_field(); ?>
                        ...
                        <div>
                            ...
                            <select name="status" id="status" required
                                ...
                                <option value="shipped" <?php echo e($shipment->status === 'shipped' ? 'selected' : ''); ?>>Shipped</option>
        ...
        <!-- Upload POD -->
        <?php if($shipment->status === 'delivered' && !$shipment->pod_file_path): ?>
            <div class="bg-white shadow sm:rounded-lg mt-6">
                <div class="px-4 py-5 sm:p-6">
                    <h3 class="text-lg leading-6 font-medium text-gray-900 mb-4">Upload Proof of Delivery</h3>
                    
                    <form method="POST" action="<?php echo e(route('admin.shipments.uploadPOD', $shipment)); ?>" enctype="multipart/form-data" class="space-y-4">
                        <?php echo csrf_field(); ?>
        ...
        <!-- Back Button -->
        <div class="mt-6">
            <a href="<?php echo e(route('admin.shipments.index')); ?>" class="inline-flex items-center px-4 py-2 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                Back to Shipments
            </a>
        </div>
    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\user\CascadeProjects\invotrack-laravel\resources\views/shipments/show.blade.php ENDPATH**/ ?>