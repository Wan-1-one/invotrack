...
<?php $__env->startSection('content'); ?>
        <div class="px-4 py-6 sm:px-0">
                ...
                <div class="border-b pb-6 mb-6">
                    <div class="flex justify-between items-start">
                        <div>
                            ...
                            <p class="text-gray-600 mt-1">Order: <?php echo e($invoice->order->order_number); ?></p>
                        </div>
                    ...
                    <div>
                        ...
                        <div class="space-y-3">
                            <div class="flex justify-between">
                                ...
                                <span class="font-medium"><?php echo e($invoice->order->order_number); ?></span>
                            </div>
                            <div class="flex justify-between">
                                <span class="text-gray-600">Order Date:</span>
                                <span class="font-medium"><?php echo e($invoice->order->created_at->format('M d, Y')); ?></span>
                            </div>
                            <div class="flex justify-between">
                                <span class="text-gray-600">Order Status:</span>
                                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium
                                    <?php echo e($invoice->order->status === 'confirmed' ? 'bg-green-100 text-green-800' : 
                                       ($invoice->order->status === 'pending' ? 'bg-yellow-100 text-yellow-800' : 'bg-gray-100 text-gray-800')); ?>">
                                    <?php echo e($invoice->order->status); ?>

                                </span>
                            </div>
                            <div class="flex justify-between">
                                <span class="text-gray-600">Customer:</span>
                                <span class="font-medium"><?php echo e($invoice->order->customer_name); ?></span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="flex justify-end space-x-4">
                ...
                <?php endif; ?>
                <a href="<?php echo e(route('customer.orders.show', $invoice->order)); ?>" 
...
<?php echo $__env->make('customer.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\user\CascadeProjects\invotrack-laravel\resources\views/customer/invoices/show.blade.php ENDPATH**/ ?>