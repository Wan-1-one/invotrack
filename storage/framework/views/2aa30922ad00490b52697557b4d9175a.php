                ...
                <div class="mb-8 p-6 bg-gray-50 rounded-lg">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <p class="font-medium">RM<?php echo e(number_format($invoice->payments->sum('amount'), 2)); ?></p>
                        </div>
                    </div>
                    <div class="mt-4 pt-4 border-t">
                        <div class="flex justify-between items-center">
                            ...
                            <span class="text-lg font-bold text-purple-600">
                                RM<?php echo e(number_format($invoice->amount - $invoice->payments->sum('amount'), 2)); ?>
...
<?php echo $__env->make('customer.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\user\Documents\invotrack-laravel\resources\views/customer/payments/create.blade.php ENDPATH**/ ?>