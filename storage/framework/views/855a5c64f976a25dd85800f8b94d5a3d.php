    ...
    <div class="border-4 border-dashed border-gray-200 rounded-lg p-6">
        ...
        <form method="POST" action="<?php echo e(route('admin.orders.store')); ?>" class="space-y-6">
                ...
                <div class="px-4 py-5 sm:p-6">
                    ...
                    <div class="mt-6">
                        ...
                        <textarea name="customer_address" id="customer_address" rows="3" required
                                  class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"><?php echo e(old('customer_address')); ?></textarea>
                    </div>
            ...
            <div class="flex justify-end space-x-3">
                <a href="<?php echo e(route('admin.orders.index')); ?>" class="bg-white py-2 px-4 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                    Cancel
                </a>
...
<?php echo $__env->make('invotrack.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\user\Documents\invotrack-laravel\resources\views/invotrack/orders/create.blade.php ENDPATH**/ ?>