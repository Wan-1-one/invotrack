                ...
                <div class="premium-card bg-gradient-to-br from-emerald-500 to-emerald-600 rounded-2xl shadow-lg border border-emerald-400 p-8 relative overflow-hidden">
                    ...
                    <div class="relative z-10">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-white/60">{{ $stats['total_invoices'] > 0 ? round(($stats['paid_invoices'] / $stats['total_invoices']) * 100, 1) : 0 }}% completion rate</p>
                        </div>
                    </div>
                </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 fade-in">
                ...
                <div class="bg-white rounded-lg shadow-lg p-6">
                    <div class="flex justify-between items-center mb-4">
                        ...
                        <a href="{{ route('admin.orders.index') }}" class="text-blue-600 hover:text-blue-500 text-sm font-medium">View All</a>
                    </div>
                                ...
                                <div class="border border-gray-200 rounded-lg p-4 hover:border-blue-300 transition-colors">
                                    <div class="flex justify-between items-start">
                                        ...
                                        <div class="text-right">
                                            ...
                                            <br>
                                            <a href="{{ route('admin.orders.show', $order) }}" class="text-blue-600 hover:text-blue-500 text-sm mt-2 inline-block">
                                                View Details
                                            </a>
                                        </div>
                                    </div>
                ...
                <div class="bg-white rounded-lg shadow-lg p-6">
                    <div class="flex justify-between items-center mb-4">
                        ...
                        <a href="{{ route('admin.invoices.index') }}" class="text-blue-600 hover:text-blue-500 text-sm font-medium">View All</a>
                    </div>
                                ...
                                <div class="border border-gray-200 rounded-lg p-4 hover:border-blue-300 transition-colors">
                                    <div class="flex justify-between items-start">
                                        <div>
                                            ...
                                            <p class="text-sm text-gray-600">{{ $invoice->order ? $invoice->order->customer_name : 'N/A' }}</p>
                                            <p class="text-sm text-gray-500">RM{{ number_format($invoice->amount, 2) }}</p>
                                        ...
                                        <div class="text-right">
                                            ...
                                            <br>
                                            <a href="{{ route('admin.invoices.show', $invoice) }}" class="text-blue-600 hover:text-blue-500 text-sm mt-2 inline-block">
                                                View Details
                                            </a>
                                        </div>
                                    </div>
