        ...
        <div class="mb-8">
                ...
                <div class="bg-gradient-to-r from-blue-500 to-blue-600 rounded-lg shadow-lg p-6 text-white">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-2xl font-bold">{{ $stats['paid_invoices'] }}</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-gradient-to-r from-green-500 to-green-600 rounded-lg shadow-lg p-6 text-white">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-2xl font-bold">{{ $stats['delivered_orders'] }}</p>
                        </div>
                    </div>
                </div>
            ...
            <div class="bg-white rounded-lg shadow-lg p-6">
                <div class="flex justify-between items-center mb-4">
                    ...
                    <a href="{{ route('customer.orders.index') }}" class="text-purple-600 hover:text-purple-500 text-sm font-medium">View All</a>
                </div>
                            ...
                            <div class="border border-gray-200 rounded-lg p-4 hover:border-purple-300 transition-colors">
                                <div class="flex justify-between items-start">
                                    <div>
                                        ...
                                        <p class="text-sm text-gray-600">RM{{ number_format($order->total_amount, 2) }}</p>
                                    ...
                                    <div class="text-right">
                                        ...
                                        <br>
                                        <a href="{{ route('customer.orders.show', $order) }}" class="text-purple-600 hover:text-purple-500 text-sm mt-2 inline-block">
                                            View Details
                                        </a>
                                    </div>
                                </div>
                ...
                @else
                    <div class="text-center py-8">
                        ...
                        <div class="mt-6">
                            <a href="{{ route('customer.orders.create') }}" class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-white bg-purple-600 hover:bg-purple-700">
