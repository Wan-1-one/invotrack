                ...
                <div class="mb-6">
                    <div class="flex items-center justify-between mb-2">
                        ...
                        <div class="flex items-center">
                            <div class="w-8 h-8 rounded-full flex items-center justify-center text-xs font-medium 
                                {{ $shipment->status === 'shipped' || $shipment->status === 'delivered' ? 'bg-green-100 text-green-700' : ($shipment->status === 'pending' ? 'bg-yellow-100 text-yellow-700' : 'bg-blue-100 text-blue-700 animate-pulse') }}">
                                3
                            </div>
                        ...
                        <div class="flex items-center">
                            <div class="w-8 h-8 rounded-full flex items-center justify-center text-xs font-medium 
                                {{ $shipment->status === 'delivered' ? 'bg-green-100 text-green-700' : 'bg-gray-100 text-gray-600' }}">
                                4
                            </div>
                    ...
                    <div class="w-full bg-gray-200 rounded-full h-2">
                        <div class="bg-gradient-to-r from-purple-600 to-pink-600 h-2 rounded-full" 
                             style="width: {{ $shipment->status === 'delivered' ? '100' : ($shipment->status === 'shipped' ? '75' : '50') }}%"></div>
                    </div>
                </div>
